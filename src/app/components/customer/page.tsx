...
const Customer = () => {
  return (
    <>
      ...
      <div>
        <h1 className="flex justify-center title-font text-5xl mb-4 font-bold text-black">
        ...
        <div className="flex justify-center my-8">
          <button className="text-white bg-[#0D7ABF] border-0 py-2 px-6 focus:outline-none hover:bg-[#0a5483] rounded-[26px] text-xl">
            CONTACT US
          </button>
        </div>
      </div>
